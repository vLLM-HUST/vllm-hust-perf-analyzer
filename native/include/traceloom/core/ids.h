...
struct StreamIdTag {};
struct TaskIdTag {};
struct EventReconciliationDecisionIdTag {};
struct CommunicationOpIdTag {};
struct RuntimeCallIdTag {};
struct AnchorIdTag {};
struct TokenIdTag {};
...
using EventReconciliationDecisionId = Id<EventReconciliationDecisionIdTag>;
using CommunicationOpId = Id<CommunicationOpIdTag>;
using RuntimeCallId = Id<RuntimeCallIdTag>;
