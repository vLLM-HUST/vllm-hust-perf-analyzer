...
int main() {
  ...
  require(load_sqlite_master_names(db_path, "index") ==
          std::vector<std::string>({
              ...
              "idx_traceloom_clock_marker_device",
              "idx_traceloom_clock_marker_source",
              "idx_traceloom_clock_model_device",
              ...
              "idx_traceloom_host_api_connection",
              "idx_traceloom_host_api_source",
              "idx_traceloom_host_api_time",
              "idx_traceloom_idle_candidate_gap",
              ...
              "idx_traceloom_task_api_link_api",
