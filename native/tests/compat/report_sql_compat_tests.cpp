...
std::vector<QueryCase> active_query_cases() {
  return {
      ...
      QueryCase{
          ...
          {
              "bubble_id", "structural_position_id", "right_occurrence_idx",
              "right_node_symbol", "bubble_us", "transition_compute_us",
              "transition_comm_us", "transition_total_us",
              "host_observation_status", "host_interval_us",
