  ...
  insert_values(
      db, "traceloom_projection_coordinate",
      {
          ...
          {"replay_hpo_positions", "10", "position_id",
           "replay_body_pattern_id", "selected replay-body Position"},
          {"replay_hpo_refinements", "10", "parent_position_id",
           "replay_body_pattern_id", "current replay-body Position"},
          {"replay_hpo_refinements", "20", "child_position_id",
           "replay_body_pattern_id", "child replay-body Position"},
          {"replay_hpo_occurrences", "10", "position_id",
           "replay_body_pattern_id", "selected replay-body Position"},
          {"replay_hpo_occurrences", "20", "occurrence_id",
           "replay_body_pattern_occurrence_id", "replay-body Position Occurrence"},
          {"replay_hpo_members", "10", "parent_position_id",
           "replay_body_pattern_id", "owning replay-body Position"},
          {"replay_hpo_members", "20", "parent_occurrence_id",
           "replay_body_pattern_occurrence_id", "owning replay-body Occurrence"},
          {"replay_hpo_members", "30", "child_position_id",
           "replay_body_pattern_id", "direct child Position when present"},
          {"replay_hpo_members", "40", "child_occurrence_id",
           "replay_body_pattern_occurrence_id", "direct child Occurrence when present"},
