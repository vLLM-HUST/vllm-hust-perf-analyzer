...
const CompatTableSchema& clock_marker_table_schema() {
  static const CompatTableSchema schema{
      "traceloom_clock_marker",
      {
          ...
          {"profiler_host_start_ns", CompatColumnType::kInteger, true},
          {"profiler_host_end_ns", CompatColumnType::kInteger, true},
          {"profiler_host_midpoint_ns", CompatColumnType::kInteger, true},
          ...
          {"resolution_method", CompatColumnType::kText, false},
          {"resolution_residual_ns", CompatColumnType::kReal, true},
          {"source_kind", CompatColumnType::kText, false},
          {"source_table", CompatColumnType::kText, false},
          {"source_key", CompatColumnType::kText, false},
          {"contract_version", CompatColumnType::kText, false},
...
const CompatTableSchema& clock_model_table_schema() {
  static const CompatTableSchema schema{
      "traceloom_clock_model",
      {
          ...
          {"intermediate_clock_domain", CompatColumnType::kText, false},
          ...
          {"has_profiler_host_mapping", CompatColumnType::kInteger, false},
          {"marker_to_device_scale", CompatColumnType::kText, false},
          {"marker_to_device_offset_ns", CompatColumnType::kText, false},
          {"reference_marker_host_ns", CompatColumnType::kText, false},
          {"marker_reference_device_ns", CompatColumnType::kText, false},
          {"marker_to_device_drift_ppm", CompatColumnType::kReal, false},
          {"profiler_to_marker_scale", CompatColumnType::kText, false},
          {"profiler_to_marker_offset_ns", CompatColumnType::kText, false},
          {"reference_profiler_host_ns", CompatColumnType::kText, false},
          {"profiler_reference_marker_ns", CompatColumnType::kText, false},
          {"profiler_to_marker_drift_ppm", CompatColumnType::kReal, false},
          ...
          {"host_clock_absolute_residual_p50_ns", CompatColumnType::kReal,
           false},
          {"host_clock_absolute_residual_p95_ns", CompatColumnType::kReal,
           false},
          {"host_clock_absolute_residual_max_ns", CompatColumnType::kReal,
           false},
          {"host_clock_uncertainty_p95_ns", CompatColumnType::kReal, false},
          {"composed_absolute_residual_p50_ns", CompatColumnType::kReal,
           false},
          {"composed_absolute_residual_p95_ns", CompatColumnType::kReal,
           false},
          {"composed_absolute_residual_max_ns", CompatColumnType::kReal,
           false},
          {"direct_overlap_marker_count", CompatColumnType::kInteger, false},
